...
const api = axios.create({
  baseURL: "https://transpolink.onrender.com/api",
  headers: {
...
export const authAPI = {
  ...
  verifyOtp: async ({ email, phone, otp }) => {
    const response = await api.post('/auth/verify-otp', { email, phone, otp });
    return response.data;
  },

  // Reset password
  resetPassword: async ({ email, phone, otp, newPassword }) => {
